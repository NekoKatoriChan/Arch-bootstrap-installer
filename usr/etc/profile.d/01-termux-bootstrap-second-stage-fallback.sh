...
(
	...
	if [ ! -L "/data/data/com.termux/files/usr/etc/termux/bootstrap/termux-bootstrap-second-stage.sh.lock" ]; then
		echo "Starting fallback run of termux bootstrap second stage"
		chmod +x "/data/data/com.termux/files/usr/etc/termux/bootstrap/termux-bootstrap-second-stage.sh" || exit $?
		"/data/data/com.termux/files/usr/etc/termux/bootstrap/termux-bootstrap-second-stage.sh" || exit $?
	fi
